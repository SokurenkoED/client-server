...
namespace TcpSendFiles
{
    ...
    class TcpModule
    {
        ...
        public string SendFileName = "totigr.dat";
        ...
        private bool _IsConnectTrue = false;

        public bool IsConnectTrue 
        {
            get
            {
                return _IsConnectTrue;
            }
            set
            {
                _IsConnectTrue = value;
            }
        }
